...
$router->group(['prefix' => 'api'], function ($router) {
    ...
    // Access Requests
    $router->get('/access-requests', 'CustomerController@indexAccessRequests');
    $router->post('/access-requests/{id}/approve', 'CustomerController@approveAccessRequest');
    $router->delete('/access-requests/{id}', 'CustomerController@deleteAccessRequest');
});
